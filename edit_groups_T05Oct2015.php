...
<title><?php echo $lang['Editing Group'];?></title>
<head>
...
<div class="col-md-4">
<textarea class="form-ontrol" name="desciption"><?php echo $res['description'];?></textarea>
</div>
</div>
           ...
           <div class="col-md-4">
              ...
              <label class="checkbox-inline control-label"> <?php echo $lang['Open — Anyone can join and view this group'];?>. </label></div>
                 ...
                 <div class="radio">
					...
					<label class="checkbox-inline control-label"><?php echo $lang["Private — This group requires approval for new members to join. Anyone can view the group's description"];?>.<?php echo $lang['$lang["Only group members are allowed to see the groups content"]'];?>. </label> </div>
                    </div>
