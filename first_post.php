...
$objMemberFirstPost = new member1(); 
...
if($block_count==0 && $row['status']==6)
	{
	//echo $block_count;
	//echo $memb_id;
	//echo $member_id;
	
	$postMemberResultHeader1ProfileLogo=$objMemberFirstPost->select_member_meta_value($memb_id,'current_profile_image');
	$postUserProfilePic='';
	if($postMemberResultHeader1ProfileLogo){			
		$postUserProfilePic=SITE_URL.'/'.$postMemberResultHeader1ProfileLogo;	
	}
	else{
		$postUserProfilePic=SITE_URL.'/images/default.png';
	}
	...
	$postSharedMemberResultProfileLogo=$objMemberFirstPost->select_member_meta_value($share_member_id,'current_profile_image');
	$postSharedUserProfilePic='';
	if($postSharedMemberResultProfileLogo){			
		$postSharedUserProfilePic=SITE_URL.'/'.$postSharedMemberResultProfileLogo;	
	}
	else{
		$postSharedUserProfilePic=SITE_URL.'/images/default.png';
	}
...
<?php 
if($row['share'] != 1){
$profpic = $postUserProfilePic;
$shusername = $base_url.$row['username'];
} else {
$profpic = $postSharedUserProfilePic;
...
var videoidqwPos = "<?php Print($videoid); ?>";
var video= $('.videoPlayer','#'+videoidqwPos)[0]; 

var videoJ= $('.videoPlayer','#'+videoidqwPos);        
