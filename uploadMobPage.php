...
<div class="file_upload">
		<input type="file" id="uploadFile" class="inputbox" type="file" value="" size="45" name="uploadedfile" required="required" accept="video/*">
	</div>
<!--<input id="uploadFile" class="inputbox" type="file" value="" size="45" name="uploadedfile" required="required" accept="video/*" >-->
