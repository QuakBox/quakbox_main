...
if (isset($_GET['id']) && $_GET['id'] != '') {
    $adds_id = $_GET['id'];
    $query = "select * from ads where ads_id='$adds_id' And ad_creator='$member_id' limit 1";
...
<script type="text/javascript" >
 $(document).ready(function() { 
		...
		$("#preview").html('<img src="<?php echo $res['ads_pic'];?>" height="150px" width="150px" alt=""/>');
...
<div class="adsheading">Edit Your Ads &nbsp;&nbsp;&nbsp;<a style="color:#261f50;" href="<?php echo $base_url;?>view_add_user.php">View Ads</a></div>
<br>
<div class="adsdiv">
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <td align="right">Ads &nbsp;&nbsp; <input name="typeofadd" id="rad" value="<?php echo $lang['Social Ads'];?>" type="radio"  <?php echo ($res['typeofadd']=='Social Ads')?'checked':'' ?>/>&nbsp;<?php echo $lang['Social Ads'];?> 
 <td class="adstd2"><input name="typeofadd" id="rad" value="<?php echo $lang['Partners'];?>" type="radio" <?php echo ($res['typeofadd']=='Partners')?'checked':'' ?>/>&nbsp;<?php echo $lang['Partners'];?></td>
  ...
  <td class="adstd3"><select id="http" name="http" >
    ...
    <td class="adstd2">
        <input id="title2" class="required inputbox" type="text" value="<?php $url= explode("//", $res['url']); echo $url[1];?>" size="40" name="url" /></td>
 <tr>
     ...
     <td class="adstd3">
     <input id="title" class="required inputbox" type="text" value="<?php echo $res['ads_title'];?>" size="40" name="title"  required="required"></td>
</tr>
<!---
 <tr>
...
<td class="adstd2">
<textarea id="description" class="required inputbox" type="text" value="" size="45"  name="description" required="required"><?php echo $res['ads_content'];?></textarea></td>
</tr>
<tr>
  <td colspan="4"></td>
</tr>
...
<tr>
  ...
  <label ><?php echo $lang['Gender'];?></label></td>
    <td class="adstd2">&nbsp;
      ...
      <input type="checkbox" name="gender" value="female" <?php echo ($res['targetgender']=='female' ? 'checked' : '');?>><?php echo $lang['Female'];?> </td>
  </tr>
  ...
  <tr>
    ...
    <td class="adstd2"><select class="adsselect" id="country" onchange="load_options(this.value,'state',''); pot_user()" name="countries">
      <option value="<?php echo $res['targetcountry'];?>" ><?php echo $lang['Select country'];?></option>
    </select></td>
  </tr>
  <tr>
    ...
    <td class="adstd2"><select class="adsselect" id="state" onchange="load_options(this.value,'city','');" name="state">
      <option value="<?php echo $res['targetstate'];?>" selected="selected"><?php echo $lang['Select state'];?></option>
    </select></td>
  </tr>
  <tr>
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <label ><br><?php echo $lang['How many clicks/impressions do you want to buy'];?>?</label>
      ...
      <td class="adstd2"><br><input name="click_payment" class="adsselect"  size="10" id="click_payment" type="text" value="<?php echo $res['pricingbuy'];?>"/><span id="errmsg"></span></td></tr>
