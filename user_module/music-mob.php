...
<!--<input type="file" name="musiccover" id="musiccover" accept="image/*" required="required">-->
<div class="file_upload">
		<input type="file" id="musiccover" name="musiccover" accept="image/*" required="required">
	</div>
</div>
<br />
<div class="form-group">
<label>Music audio</label>
<!--<input type="file" name="musicaudio" id="musicaudio" accept="audio/*" required="required">-->
<div class="file_upload">
		<input type="file" id="musicaudio" name="musicaudio" accept="audio/*" required="required">
	</div>
</div>
<br />
