<?php 
	...
	$sql = mysqli_query($con, "select * from groups_discuss g,members m where m.member_id=g.creator and g.id='".$discuss_id."'") or die(mysqli_error($con));
...
<div class="page-action"><a class="icon-report"><span>Report Discussion</span></a></div>
...
Discussion started by <a href="#"><?php echo $res['username'];?></a>, on <?php echo date('l, j F Y',$res['created']);?>
</div>
<div class="discussion-entry"><?php echo $res['message'];?></div>
