...
!function (a) {
    ...
    a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        setPosition: function () {
            ...
            !function () {
                var a = this.tip();
                var b = "function" == typeof this.options.placement ? this.options.placement.call(this, a[0], this.$element[0]) : this.options.placement, c = /\s?auto?\s?/i, d = c.test(b);
                d && (b = b.replace(c, "") || "top");
                var e = this.getPosition();
                var f = 0, g = 0;//("offsetWidth" in a[0]) ? a[0].offsetWidth : 0, g = ("offsetHeight" in a[0]) ? a[0].offsetHeight : 0;
                if (d) {
