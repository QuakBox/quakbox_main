(function($) {
    ...
    $.fn.oembed.getPhotoCode = function(url, oembedData) {
        ...
        var replaced_content = oembedData.url;
        replaced_content = replaced_content.replace('http', 'https');
        code = '<div><a href="' + url + '" target=\'_blank\'><img src="' + replaced_content + '" alt="' + alt + '"/></a></div>';
                ...
                extraSettings.yql = {
                    ...
                    datareturn: function(results) {
                        if (results.json.type != 'video' && (results.json.url || results.json.thumbnail_url)) {
                            var content1 = results.json.url; var content2 = results.json.thumbnail_url;
                            content1 = content1.replace('http', 'https');content2 = content2.replace('http', 'https');
                            return '<img src="' + (content1 || content2) + '" />';
                        }
    ...
    $.fn.oembed.providers = [new $.fn.oembed.OEmbedProvider("youtube", "video", ["youtube\\.com/watch.+v=[\\w-]+&?", "youtu\\.be/[\\w-]+", "youtube.com/embed"], 'https://www.youtube.com/embed/$1?wmode=transparent', {
    ...
    }), new $.fn.oembed.OEmbedProvider("mobypicture", "photo", ["mobypicture.com/user/.+/view/.+", "moby.to/.+"], "http://api.mobypicture.com/oEmbed"), new $.fn.oembed.OEmbedProvider("flickr", "photo", ["flickr\\.com/photos/.+"], "https://flickr.com/services/oembed", {
        ...
        templateData: function(data) {
            ...
            var teaserimg = data.image_teaser_url;
            teaserimg = teaserimg.replace('http', 'https');
            return '<img src="' + teaserimg + '"/>';
        }
        ...
        templateData: function(data) {
            ...
            var content3 = data.image;content3 = content3.replace("http", "https");
            return '<div><img src="' + content3 + '" align="left" style="margin-right: 1em;" /><span class="oembedall-ljuser"><a href="http://' + data.username + '.livejournal.com/profile"><img src="https://www.livejournal.com/img/userinfo.gif" alt="[info]" width="17" height="17" /></a><a href="http://' + data.username + '.livejournal.com/">' + data.username + '</a></span><br />' + data.name + '</div>';
        }
        ...
        templateData: function(data) {
            ...
            if (data.picture){var contentfb = data.picture; contentfb = contentfb.replace("http", "https");  out += '<a href="' + data.link + '"><img src="' + contentfb + '"></a>';}
            else out += '<img src="https://graph.facebook.com/' + data.id + '/picture">'; if (data.from) out += '<a href="' + data.link + '">' + data.name + '</a>';
        ...
        format: 'jsonp'
    }), new $.fn.oembed.OEmbedProvider("roomsharejp", "rich", ["roomshare\\.jp/(en/)?post/.*"], "http://roomshare.jp/oembed.json"), new $.fn.oembed.OEmbedProvider("lanyard", "rich", ["lanyrd.com/\\d+/.+"], null, {
        yql: {
        ...
        yql: {
            ...
            datareturn: function(results) {
                ...
                var imageforog = results['og:image'];
                imageforog = imageforog.replace("http", "https");
                    var img = $('<img src="' + imageforog + '">');
                    code.append(img);
                }
                return code;
            }
