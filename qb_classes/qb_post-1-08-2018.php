...
function insert_post_video($memberID,$title,$description,$encryptedWallID,$ip,$privacy,$videoname,$wallItem){	
	...
	$NameWithoutExtension   = $videoname;
	...
	//die( "INSERT3INTO message (member_id,messages,type,wall_privacy,date_created,ip,url_title,description,wall_type) 
...
$portal_notification_href = "";
	...
	<a href='".$base_url."/i/".$post_creator_username."' target='_blank' style='color:#3b5998;text-decoration:none'>
