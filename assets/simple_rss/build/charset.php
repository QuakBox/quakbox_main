...
{
	return strtolower( preg_replace_callback('/(?:[^a-zA-Z0-9]+|([^0-9])0+)/', 'callback_single_space', $charset));
}
function callback_single_space($m)
{
...
public static function encoding(\$charset)
{
	...
	switch (strtolower(preg_replace_callback('/(?:[^a-zA-Z0-9]+|([^0-9])0+)/', 'callback_single_space', \$charset)))
	{
