...
$uname = mysqli_real_escape_string($con, f($_POST['uname'],'escapeAll'));
$mem_id = mysqli_real_escape_string($con, f($_POST['mem_id'],'escapeAll'));

mysqli_query($con, "INSERT INTO event_wall_reply_reply (member_id,reply_id,content, date_created)
...
$sql = mysqli_query($con, "select * from  event_wall_reply_reply a JOIN members m ON m.member_id = a.member_id where reply_id = '$comment_id' order by id desc");
