...
<?php    echo "<div id='create_div' style='text-align:right; padding-top: 15px; margin-bottom:20px; width:90%;'><a href='create_country_event.php?country=$country_code'><input type='button' value='".$lang['Create Event']."'/></a></div>";?>
