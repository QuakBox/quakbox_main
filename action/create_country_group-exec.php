<?php ob_start();
	...
	$country_id = mysqli_real_escape_string($con, f($_POST['country_id'],'escapeAll'));
	...
	//Insert query
	$sql = "insert into groups(ownerid,name,avatar,description,categoryid,approvals,created,discussordering,photopermission,grouprecentphotos,videopermission,grouprecentvideos,newmembernotification,joinrequestnotification,wallnotification,type,country_id) values('$member_id','$name','$avatar','$desciption','$categoryid','$approvals','$time','$discussordering','$photopermission','$grouprecentphotos','$videopermission','$grouprecentvideos','$newmembernotification','$joinrequestnotification','$wallnotification',1,'$country_id')";
