<?php
	...
	$checkValue = $memberObject->select_member_meta_value($member_id,"first_name");
	if($name=='member_name' && $value != ''){
	
		if($checkValue ==null)
		{
		$memberResult = $memberObject->insert_member_meta($member_id,"first_name",$value);
		}
		else
		{
		$memberResult = $memberObject->update_member_meta($member_id,"first_name",$value); 
		}
	}
