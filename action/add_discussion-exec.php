...
$title   = mysqli_real_escape_string($con, $title);
	...
	//Insert query
	$sql = "insert into groups_discuss(groupid,creator,created,title,message) values('$group_id','$member_id','$time','$title','$desciption')";
	$result = mysqli_query($con, $sql) or die(mysqli_error($con));
	
	//Check whether the query was successful or not
	if($result) 
	{	
		header("location: ".$base_url."view_discussion.php?group_id=".$group_id."");
		exit();		
	}
?>