...
include('../config.php');
	...
	$share_member 	= 	f($_POST['photo_custom_share'], 'strip');
	$share_member 	= 	f($share_member , 'escapeAll');
	$share_member   = 	mysqli_real_escape_string($con, $share_member);
		
	$unshare_member = 	f($_POST['photo_custom_unshare'], 'strip');
 ...
 $sqlnfeeds = "INSERT INTO news_feeds ";
        ...
        mysqli_query($con, $sqlnfeeds);
			...
			{	
				...
				mysqli_query($con, $insertMemberAlbum) or die(mysqli_error($con)) ;
