...
$comment = mysqli_real_escape_string($con, f($_POST['report'],'escapeAll'));
$msg_id = mysqli_real_escape_string($con, f($_POST['msg_id'],'escapeAll'));

mysqli_query($con, "INSERT INTO event_wall_report (member_id,msg_id,report, date_created)
VALUES('$member_id','$msg_id','$comment','".strtotime(date("Y-m-d H:i:s"))."')") or die(mysqli_error($con));

//mail function
$to = 'admin@quakbox.com';
