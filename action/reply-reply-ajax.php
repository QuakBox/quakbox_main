...
$comment_id = f($_POST['reply_id'],'escapeAll');
...
mysqli_query($con, "INSERT INTO reply_reply (member_id,reply_id,content, date_created)
...
$sql = mysqli_query($con, "select * from reply_reply a JOIN members m ON m.member_id = a.member_id where reply_id = '$comment_id' order by id desc");
...
if ($res)
{
	...
	$cface = $res['profImage'];
?>
<div class="reply-reply-body" id="reply-reply-body<?php echo $com_id; ?>">
