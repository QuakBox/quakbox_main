...
$time = time();
$wall_privacy = $_POST['privacy'];
$wall_privacy	 = 	f($wall_privacy, 'strip');
$wall_privacy	 = 	f($wall_privacy, 'escapeAll');
$wall_privacy   = mysqli_real_escape_string($con, $wall_privacy);
...
//insert into videos table
	...
	$sql = mysqli_query("SELECT msg.messages_id, msg.messages, msg.date_created, msg.type, msg.wall_privacy, m.member_id,
