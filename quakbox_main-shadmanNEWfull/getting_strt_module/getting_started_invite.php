...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <div class="container">
	  ...
	  <div class="panel-heading">
	    <h3 class="panel-title"><?php echo $lang['invitefriends'];?></h3>
	  </div>
	  <div class="panel-body">
	    <div class="row">
		  <form name="email_list" id="email_list" method="post" action="<?php echo $base_url;?>action/multiple_invite.php">
			<!--start inbox-toolbar div-->
			<div class="inbox-toolbar">
			<table class="table" width="100%" cellspacing="0" cellpadding="2" border="0" style="border-collapse:collapse; border-spacing:0px; border:1px solid #CCCCCC;">
			<tbody>
			<tr>
			<td align="center" width="30">
			<input id="selectall" type="checkbox" />
			</td>
			<td><?php echo $lang['Select All'];?></td>
			</tr>
			</tbody>
			</table>
			...
			<input class="checkbox" type="checkbox" name="email[]" value="<?php echo $cres['email'];?>" />
			</td>
			<td style="padding:5px; border:1px solid #CCCCCC;vertical-align:middle"><?php echo $cres['email'];?></td>
			...
			<div class="rfloat">
			<?php if($ccount > 0){?>
			<button  type="submit" name="submit" class="btn btn-success" ><?php echo $lang['Invite'];?></button> <?php }?>	
			</div>
			</div>
		</form>
	    </div>
	  ...
	  <a href="<?php echo $base_url;?>registerProfile.php" onclick="document.write('<?php $object-> skipChekPoints($member_id, 'Importing Contacts') ?>');" class="btn btn-warning" ><?php echo $lang['Skip'];?></a>	
	  </div>
	</div>
        </div>
      </div>
