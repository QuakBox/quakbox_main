...
<div class="column_internal_right" id="column_internal_right">
   ...
   $r=0;
   $ad_count=0;
   $ads_sql = mysqli_query($con, "select * from ads where ads_title!='' OR ads_pic!='' order by rand() limit 10");
   ...
   <div class="panel panel-default nopadding">
        ...
        <div class="panel-heading" style="height: 20px;padding: 1px;">
            <a  target="_blank" href="<?php echo $ads_res['url'];?>"><b>
         <?php
       // echo $_SEESION['lang'];
	...
	<?php if(!empty($ads_res['ads_pic'])){ ?>
        <center>
        <a href="<?php echo $ads_res['url'];?>" target="_blank">
            <img src="<?php echo $base_url.$ads_res['ads_pic'];?>" style="width: 100%; height: 100%;"/>
        </a>
        </center>
	<?php } ?>            
            
         <div class="ads-description nopadding">
        <?php
       // echo $_SEESION['lang'];
