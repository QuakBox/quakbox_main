<?php
	...
	$pvsql = mysqli_query($con, "select msg.video,url,msg.messages,msg.url_title,msg.date_created,msg.messages_id,msg.view_count,m.member_id,msg.type 
						from message msg left join members m on m.member_id = msg.member_id 
...
<div class="column_left_video">
 ...
 <div id="submenushead">
   <ul class="submenu">
    <li><input type="button" name="add_video" class="button" value="Country videos" 
    onclick="history.go(-1);return false;" style="font-size:14px;" /></li>
...
$musql = "update message set view_count = '$view_count' where messages_id = '$msg_id'";
...
$sql = mysqli_query($con, "SELECT * FROM bleh WHERE remarks='". $mrow['messages_id'] ."'");
...
<div class="comment-menu">
	...
	<span id="show-cmt1">
 <?php
 $q = mysqli_query($con, "SELECT * FROM bleh WHERE member_id='". $_SESSION['SESS_MEMBER_ID'] ."' and remarks='".$mrow['messages_id']."' ");
...
<?php
$comment  = mysqli_query($con, "SELECT * FROM postcomment p,members m  
...
<?php
$comment_like = mysqli_query($con, "select * from comment_like where comment_id = '".$row1['comment_id']."' and member_id = '".$session_member_id."'");
...
$vsql = mysqli_query($con, "select msg.video,msg.url,msg.messages,msg.url_title,msg.date_created,msg.messages_id,msg.view_count,m.username,msg.video_id
						from message msg join members m on msg.member_id = m.member_id
