...
$dob=$objMember->select_member_information($member_id_for_ads,'dob');
$gender=$objMember->select_member_meta_value($member_id_for_ads,'gender');
$countory=$objMember->select_member_meta_value($member_id_for_ads,'country');
$state=$objMember->select_member_meta_value($member_id_for_ads,'state');
$city=$objMember->select_member_meta_value($member_id_for_ads,'city');
//echo $dob."|".$countory."|".$state."|".$city;
//exit;
$adsResult=$obj->view_ads_by_meber($dob,$gender,$countory,$state,$city);
//$adsResult=$obj->view_ads();

$countOfAds=count($adsResult);
?>

<div class="bg-primary clearfix" style="padding: 5px;z-index:99999;background-color: #C0C0C0;background-image: none;background-repeat: repeat-x;">
	<?php echo $lang['Partners']; ?>
	<a style="color:#fff;" class="pull-right" href="<?php echo $base_url; ?>add_ads.php"><?php echo $lang['Create Ads']; ?></a>
	<div class="clearfix"></div>
</div>
<div class="adsPanelContainer">
