...
$clicks =mysqli_query($con, "select * from member
...
$clicks =mysqli_query($con, "select * from member ORDER BY username asc");
...
?>
    ...
    <div class="row profile_wrapper">
        ...
        <div class="col-lg-8 col-md-9 col-sm-12">
            ...
            $uname1=mysqli_query($con, "select * from member where member_id='$session_member_id'");
            ...
            //$clicks =("select vs.subcriber_member_id, m.username, m.profImage from member m INNER JOIN  videos_subscribe vs on m.member_id='vs.subcriber_member_id' where vs.member_id='$session_member_id'");
