...
?>
                                ...
                                <tr>
                                    <td  colspan="2">
                                        <form  id="adsform" method="post" action='action/ads-exec2.php'>
                                            ...
                                            Ads &nbsp;&nbsp; <input name="typeofadd" id="rad" value="<?php echo $lang['Social Ads']; ?>" type="radio" checked />&nbsp;<?php echo $lang['Social Ads']; ?> 
                                            <input name="typeofadd" id="rad" value="<?php echo $lang['Partners']; ?>" type="radio"/>&nbsp;<?php echo $lang['Partners']; ?>
                                    </td>
                                </tr>      
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="title2" class="required inputbox" type="text" value="" size="40" name="url" />        
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="title" class="required inputbox" type="text" value="" size="40" name="title"  required="required">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="MyDate2"  name="end_date" type="text"  required="required">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea id="description" class="required inputbox" type="text" value="" size="45"  name="description" required="required"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <?php echo $lang['Targeting']; ?>                                   </td> 
                                    </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="checkbox" name="gender" value="female"><?php echo $lang['Female']; ?> 
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td ><input name="click_payment" class="adsselect"  size="10" id="click_payment" type="text"/><span id="errmsg"></span></td>
                            </tr>
                            <tr>
...
<script type="text/javascript">
			...
			{
                     $("#preview").html('');
                   $("#preview").html('<img src="<?php echo $base_url;?>images/loader.gif" alt="<?php echo $lang['Uploading'];?>...."/>');
