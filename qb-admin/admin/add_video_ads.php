	 ...
	 ?>
			...
			<div class="row-fluid">
				<div class="box span12">
                    ...
                    <form class="form-horizontal" method="post" action="action/video_ads_upload.php">
						<fieldset>
                        <legend>Select video ads</legend>
							<div class="control-group">
							  <label class="control-label" for="fileInput">File input</label>
							  <div class="controls">
								<input class="input-file uniform_on" id="uploadFile" name="uploadedfile" type="file" accept="video/*">
							  </div>
							</div>
