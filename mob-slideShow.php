...
<div class="file_upload">
		<input type="file" id="slidefile" class="inputbox" type="file" size="45" name="uploadedfile" required="required" multiple="multiple" accept="image/*">
	</div>

<!--<input id="uploadFile" class="inputbox" type="file" value="" size="45" name="uploadedfile" required="required">-->
...
<select name="countries" id="countries" data-placeholder="Choose a Country..." class="chosen-select" multiple style="width:350px;" tabindex="4">
...
<?php } ?>    
     ...
     <textarea name="description" rows="5" placeholder="Description" id="fdescription" class="inputbox text3" type="text" value="" placeholder="Description"></textarea><br /><br />
 ...
 <div id="publish">
		    ...
		    <a href="#" class="myButton" id="publish_video">Save</a> &nbsp; &nbsp; &nbsp;
		     <input type="button" name="add_video" class="button" value="BACK TO MYVIDEOS" onclick="window.open('myvideos.php','_self');" />
...
<div class="rightContainer"> 
   ...
   <div id="status"></div>
	...
	<div id="videoTitle">
		 <input type="text" name="title" placeholder="Title" id="ftitle" class="required text3 inputbox" value=""/>
		
		 <select id="fontsizeid" class="required inputbox text3" name="fontsize" style="width:70px; padding:0px;" >
