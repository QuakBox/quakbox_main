...
function embed_link(url,width,height) {
	...
	if(module[0]=='chatrooms'){
		embedlink.document.write('<textarea readonly style="width:500px;height:130px"><div id="cometchat_embed_chatrooms_container" style="display:inline-block; border:1px solid #CCCCCC;"></div>\n'+embedscript+'</textarea>');
