...
$('#music_upload').click(function(){
	var music_cover =  $('#musiccover').val();
	var music_audio =  $('#musicaudio').val();
	if(music_cover == '' || music_audio == ''){
...
<div class="insideWrapper container"> 
    <div id="uploadPage"><!--First Division with upload button present-->
        ...
        <form id="music_form" name="slide_form" method="post" enctype="multipart/form-data" action="action/music_upload.php">
        <div class="form-group">
        <label>Music cover</label>
        <!--<input type="file" name="musiccover" id="musiccover" class="music_browse_button" accept="image/*" required="required">-->
        <div class="file_upload">
                <input type="file"id="musiccover" name="musiccover" class="music_browse_button" accept="image/*" required="required">
            </div>
        ...
        <!--<input type="file" name="musicaudio" id="musicaudio" class="music_browse_button" accept="audio/*" required="required">-->
        <div class="file_upload">
                <input type="file" id="musicaudio" name="musicaudio" class="music_browse_button" accept="audio/*" required="required">
            </div>
        </div>
        <br />
        <input type="button" name="submit" value="Upload" id="music_upload" class="music_browse_button">
    ...
    <!-- Left Column -->
            ...
            <div class="rightContainer" class="col-lg-6 col-md-6 col-sm-6"> 
               ...
               <div id="status"></div>
                ...
                <div id="videoTitle">
                      <input type="text" name="title" placeholder="<?php echo $lang['Title'];?>" id="ftitle" class="required text3 inputbox" value="Music"/>
