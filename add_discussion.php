...
<div class="column_left">
    ...
    <div id="submenushead">Create Discussion</div>
    </div>
    <div id="submenushead">
    <ul class="dropDown">
...
<div id="border">
<form name="find_friend" id="find_friend" action="action/add_discussion-exec.php" method="post">
...
<label style="font-weight: 700;text-align: right;">*Discussion Title</label>
</td>
...
<tr>
<td style="font-weight: bold;text-align: right;width: 130px; padding:5px;vertical-align:top;">
<label style="font-weight: 700;text-align: right;">*Discussion Message</label>
</td>
<td style="padding:5px; vertical-align:top;"><textarea style="rgb(255, 0, 0) !important; width:90%; height:100px;" id="name" class="required inputbox" type="text" value="" size="45" name="desciption"></textarea></td>
</tr>
...
<input class="button validateSubmit" type="submit" value="ADD DISCUSSION"></input>
