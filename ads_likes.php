...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <h4 class="modal-title">People Who Like This</h4></div>
        
      
      <div class="modal-body" style="overflow-y: scroll;">
      <?php 	  
	  $adssql = mysqli_query($con, "SELECT * FROM ads_like a INNER JOIN members b ON a.member_id = b.member_id
	                       WHERE ads_id='$ads_id'") or die(mysqli_error($con));
...
<div class="mini-profile" id="mini-profile_<?php echo $adsres['member_id'];?>">
<div class="mini-profile-avatar">
<a href="<?php echo $base_url.$adsres['username'];?>" title="<?php echo ucfirst($adsres['username']);?>"><img src="<?php echo $base_url.$adsres['profImage'];?>" style="width:50px; height:auto" /></a>
</div>
