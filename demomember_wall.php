...
?></div>
<a href="<?php echo $base_url;?>albums.php?back_page=<?php echo $base_url.$_SESSION['member_name'];?>&member_id=<?php echo $row['member_id']; ?>&album_id=<?php echo $row['msg_album_id']; ?>&image_id=<?php echo $row['upload_data_id'];?>" >
<?php
