...
<div class="componentheading">
    ...
    <div id="submenushead">
    <ul class="dropDown">
    <li style="border-right:padding:0 8px;"><a href="invite_friends.php">Back to Invite Friends</a></li>
...
<td width="300"><a class="subject" href="invite_friends.php?email=<?php echo $cres['email'];?>"><?php echo $cres['email'];?></a></td>
...
<script>
	function inviteMultipleContacts(){
		...
		window.location.href="<?php echo $base_url?>/invite_friends.php?email=" + emailsStr;
	}
</script>
<!--end border div-->
</div>
