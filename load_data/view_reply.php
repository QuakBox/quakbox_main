...
$reply_sql  = mysqli_query($con, "SELECT * FROM comment_reply c,members m WHERE c.member_id = m.member_id and c.comment_id=" . $_REQUEST['postId'] . " ORDER BY reply_id DESC limit 2,".$totals);
...
<?php 
 ...
 {
	 echo '@'; 
	?> <a href="<?php echo $base_url.$member_res['username'];?>"><b><?php echo $member_res['username']; ?> 
