...
<!--	<script src="https://microsofttranslator.com/ajax/v3/widgetv3.ashx" type="text/javascript"></script>-->
	...
	function set_cookie_lacale(lang, url)
	{
    	...
    	<script src="<?php SITE_URL ?>/includes/js/walls.js?v=1.5"></script>
	...
	<script src="<?php echo $base_url; ?>assets/jquery-alert-dialogs/js/jquery.alerts.js"></script>
	...
	<script type="text/javascript">
		...
		$(function($) {  
			...
			$(document).on('click', '#fetch_close', function(e){		
				...
				$('#loader').css({"border": "none","padding": "0px"});
				$('#loader').html('<div align="center" id="load" style="display:none;"><img src="https://quakbox.com/images/ajax-loader.gif" id="loading_indicator"></div>');
				   ...
				   complete: function(xhr) { 
				    console.log(xhr);
				     ...
				     if(xhr.responseText !='error'){
					     ...
					     $.post(ajaxurl34, { video_name: videoname, logFile: logfileoutput  }, function(result) {
