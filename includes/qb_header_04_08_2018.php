        ...
        <div class="container" style="width:100%!important">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg hidden-xl-down" >
                <ul class=" nav navbar-collapse collapse" style="background: #cccccc;border-color:#cccccc; ">
                    ...
                    <li><a href="/qcast.php"><img style="height: 20px;width: 20px; padding-right: 3px;" class="media-object" alt="Report Issue" src="<?php echo SITE_URL.'/';?>images/header_icons/bug.png" />Video</a></li>
