...
<?php 
//error_reporting(0); commenting to show errors -vishnu
//session_start();  commenting to check session already started or not -vishnu
...
$query  = "SELECT msg.messages_id, msg.messages,msg.share_msg, msg.date_created, msg.type, msg.wall_privacy, m.member_id,
		  msg.msg_album_id, m.active, m.username, m.profImage, msg.country_flag, u.upload_data_id,msg.share,
...
$friend_privacy =mysqli_query($con, "select * from privacy where privacy_member_id = '".$memb_id."'");
...
<span class="mySpan_dot_class"> · </span>
 <a class="translateButton<?php echo $_POST["lastid"];?> show_cmt_linkClr" href="javascript:void(0);" id="translateButton<?php echo $row1['comment_id'];?>"  ><?php echo  $lang['Translate'];?></a></span>
...
<span style="top:2px; margin-left:3px;" >
<span class="mySpan_dot_class"> · </span>
 <a class="replytranslateButton<?php echo $_POST["lastid"];?> show_cmt_linkClr" href="javascript:void(0);" id="replytranslateButton<?php echo $reply_res['reply_id'];?>"  ><?php echo $lang['Translate']; ?></a>
  </span>
...
<br /> 
<!--
<a herf="#!" style="cursor:pointer;" onclick="show(this.id)" id="<?php echo $row['reply_id'];?>"><img src="images/Glad.png"></a>-->
<!--code for smiley!-->
...
<br /> 
<!--<div id="ctextarea<?php echo $row['comment_id'];?>" onkeyup="checkdata(this.id)" onclick="checkdata(this.id)" contenteditable="true" name="comment" class="comment" style="height:70px; width:329px; border:1px solid black; overflow-y:scroll;"></div>
<div id="showimg2_<?php echo $row['comment_id'];?>" name="actcomment" style="display:none;" ></div>

<a herf="#!" style="cursor:pointer;" onclick="show(this.id)" id="<?php echo $row['comment_id'];?>"><img src="images/Glad.png"></a>-->
<!--code for smiley!-->
...
<a herf="javascript:void(0)" style="cursor:pointer;" onclick="showsmiley(this.id)" id="<?php echo $row['messages_id'];?>"><img src="images/Glad.png"></a>
<!--code for smiley!-->
...
<div class="stcommenttext" >
<form method="post" action="">
<textarea name="comment" class="comment" id="rptextarea<?php echo $row['messages_id'];?>" placeholder="<?php echo $lang['Flag this status'];?>.."></textarea>
<br />
...
<span class="mySpan_dot_class"> · </span>
 ...
 $pdislikesql = mysqli_query($con, $pdislikequery);
	...
	{
		echo '<a href="javascript: void(0)" class="post_dislike show_cmt_linkClr" id="post_dislike'.$row['messages_id'].'" title="'.$lang['Unlike'].'" rel="disLike">'.$lang['dislike'].'</a>';
	} 

	else 
	{ 
		echo '<a href="javascript: void(0)" class="post_dislike show_cmt_linkClr" id="post_dislike'.$row['messages_id'].'" title="'.$lang['Like'].'" rel="disLike">'.$lang['dislike'].'</a>';
	}
...
<span class="mySpan_dot_class"> · </span>
<a class="posttranslateButton<?php echo $_POST["lastid"];?> show_cmt_linkClr" href="javascript:void(0);" id="posttranslateButton<?php echo $row['messages_id'];?>"  ><?php echo $lang['Translate'];?></a>
</span>
<?php } } ?>
</div>
...
$("#hidden_ajax_lastid").val(<?php echo $last_id;?>);
